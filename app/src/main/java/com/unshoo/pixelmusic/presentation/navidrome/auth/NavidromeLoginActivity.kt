...
import com.unshoo.pixelmusic.presentation.components.CloudLibraryPickerItem
import com.unshoo.pixelmusic.presentation.components.CloudLibraryPickerSheet
...
class NavidromeLoginActivity : ComponentActivity() {
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.unshoo.pixelmusic.utils.AppLocaleManager.wrapContext(newBase))
    }
