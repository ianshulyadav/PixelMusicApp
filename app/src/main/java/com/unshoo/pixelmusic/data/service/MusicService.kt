...
import com.unshoo.pixelmusic.data.service.player.selectCanonicalCloudPlaybackUri
import com.unshoo.pixelmusic.ui.glancewidget.ControlWidget4x2
import com.unshoo.pixelmusic.ui.glancewidget.PixelPlayerGlanceWidget
...
class MusicService : MediaSessionService() {
    ...
    private fun Player.unwrapMappingPlayer(): Player {
        return (this as? com.unshoo.pixelmusic.data.service.player.MappingPlayer)?.innerPlayer ?: this
    }

    private fun Player.unwrapFadingPlayer(): Player {
        return (this as? com.unshoo.pixelmusic.data.service.player.FadingPlayer)?.innerPlayer ?: this
    }

    private fun wrapFadingPlayer(player: Player): Player {
        val fadingPlayer = com.unshoo.pixelmusic.data.service.player.FadingPlayer(
            innerPlayer = player,
            scope = appScope
        )
        return com.unshoo.pixelmusic.data.service.player.MappingPlayer(
    ...
    private fun getOpenAppPendingIntent(): PendingIntent {
        val intent = Intent(this, MainActivity::class.java).apply {
            ...
            action = "com.unshoo.pixelmusic.action.OPEN_PLAYER"
