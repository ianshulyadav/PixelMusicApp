...
class ManifestValidator @Inject constructor() {
     ...
     *
     * Strict by design: both [com.unshoo.pixelmusic.data.backup.format.BackupWriter]
     * and [com.unshoo.pixelmusic.data.backup.format.LegacyPayloadAdapter] always emit
